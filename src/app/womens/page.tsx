...
import styles from './womens.module.css'; // Change to './mens.module.css' if on the men's page
...
function ProductCard({ product }: { product: typeof womensProducts[0] }) {
    ...
    <main className={styles.mainContainer}>
      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>The Vallure Femme</h1>
          <p className={styles.heroDescription}>
            An exquisite orchestration of rare floral absolutes, golden ambers, and sensual musks. Designed to leave an unforgettable, hypnotic aura of sophisticated elegance.
          </p>
          <button 
            type="button" 
      ...
      <section className={styles.introSection}>
        <h2 className={styles.introTitle}>Pour Femme</h2>
        <p className={styles.introParagraph}>
          Encompassing luminous white florals, velvety Damask roses, and deep warm vanilla infusions, each composition is masterfully crafted to evoke grace, magnetism, and timeless allure. Formulated at pure extrait concentrations, these fragrances offer exceptional longevity and a captivating sillage. Whether curated for luminous daytime sophistication or intimate evening elegance, the collection embodies the absolute pinnacle of modern feminine artistry.
        </p>
      </section>
